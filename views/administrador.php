...
<html lang="en">
<head>
  <title>Sistema Web Call Center</title>
  <meta charset="utf-8">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            ...
            <div class="collapse navbar-collapse" id="opciones">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a role="presentation" href="php/Mesa/index.php">Tecnologia</a>
                    </li>
                    <li class="nav-item">
                        <a role="presentation" href="php/Supervisores/index.php">Supervisores</a>
                    </li>
                    <li class="nav-item">
                        <a role="presentation" href="php/Roles/index.php">Roles</a>
                    </li>
                    <li class="nav-item">
